...
public class TaxCalculationExample {
	...
	public static void main(String[] args) {
		...
		System.out.println("Araban�n vergisi: " + aCar.calculateTax(1000));
		System.out.println("Araban�n vergisi: " + aCar.calculateAmortizedTax(1000,2017));
		CommercialVehicle myCar = new Car("34 B 123", 2014, 1.6);
		System.out.println("Araban�n vergisi: " + myCar.calculateAmortizedTax(1000,2017));
		/*
